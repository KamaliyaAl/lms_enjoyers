    ...
    chrome:
      ...
      (self._editEnabled
        ? '<button title="' +
          ...
          '" role="tab" class="epiceditor-toggle-btn epiceditor-toggle-edit-btn">Text</button> '
        : '') +
      (self._previewEnabled
        ? '<button title="' +
          this.settings.string.togglePreview +
          '" role="tab" class="epiceditor-toggle-btn epiceditor-toggle-preview-btn">Preview</button> '
        : '') +
      (self._fullscreenEnabled
        ? '<button title="' +
        ...
        : '') +
      (self._showHelpFormatting
        ? '<a style="float: right; color: #337ab7; font-size: 12px; line-height: 30px; text-decoration: none;" target="_blank" href="/commenting-the-right-way/">How to style the text?</a>'
        : '') +
      '</div>' +
