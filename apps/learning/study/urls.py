...
from learning.study.views import (
    ...
    StudentAssignmentCommentCreateView, StudentAssignmentCommentUpdateView, StudentAssignmentDetailView,
...
urlpatterns = [
    ...
    path('assignments/', include([
        ...
        path('<int:pk>/comments/<int:comment_pk>/update/', StudentAssignmentCommentUpdateView.as_view(), name='student_assignment_comment_edit'),
